...
'''Apply upsampling to the convolutions'''
def upscale(feats, scale):
	feat_shape = getshape(feats);
	feats = tf.image.resize_nearest_neighbor(feats,(feat_shape[1]*2,feat_shape[2]*2));
	return feats;
